...
<head>
    ...
    <title>Registro | Colegio Technology Schools</title>
    <style>
        :root {
            --principal: #004ba6;
            --secundario: #e0f7f7;
...
<body>
    ...
    <div class="formulario">
        ...
        <form:form action="/usuario/registrar" method="post" modelAttribute="usuario">
            <div class="username">
                <form:input path="nombre" id="nombre" type="text" placeholder="Nombre completo" required="true"/>
            </div>

            <div class="email">
                <form:input path="email" id="email" type="text" placeholder="Correo institucional" required="true"/>
            </div>
            ...
            <div class="password">
                <form:input path="confirmarContrasena" id="confirmarContrasena" type="password" placeholder="Confirmar contraseña" required="true"/>
            </div>

            <input type="submit" value="Registrarse">

            <div class="volver">
                ¿Ya tienes cuenta? <a href="/principal/login">Inicia sesión aquí</a>
            </div>
        </form:form>
    </div>
